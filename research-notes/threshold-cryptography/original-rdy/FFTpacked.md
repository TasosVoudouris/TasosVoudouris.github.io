# Packed Secret Sharing with Finite Field FFTs
...
We use a **degree-ORDER2 polynomial** to encode both secrets and randomness:
...
The use of $T$ random field elements in the packed vector ensures **$T$-privacy**: any subset of at most $T$ shares reveals no information about the secrets. This is analogous to standard Shamir Secret Sharing security.
...
The FFT-based approach dramatically reduces the complexity of polynomial evaluation and interpolation, especially for large batch sizes, compared to naive Lagrange interpolation.
