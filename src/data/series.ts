...
export const SERIES: readonly SeriesDefinition[] = [
	...
	{name:'Discrete Logarithm Algorithms',slug:'discrete-logarithm-algorithms',shortDescription:'DLP/ECDLP foundations, BSGS, Pohlig–Hellman, Pollard’s rho, and finite-field index calculus.',description:'A focused algorithmic path through discrete logarithms: group formulation, elliptic-curve variants, generic square-root algorithms, smooth-order reductions, Pollard-style collision search, and representation-specific index-calculus attacks in finite fields.',startLabel:'Start with the DLP',group:'Public-Key & Algebraic Systems'},
