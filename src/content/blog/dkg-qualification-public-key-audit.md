---
title: "DKG Qualification, Public-Key Derivation, and Audit"
description: "Treat the qualified dealer set as key material, derive the group public key without reconstructing the scalar secret, and define the transcript and audit checks."
pubDate: "2026-08-12"
...
Next: [DKG failure cases and adversarial lessons](/series/threshold-cryptography-engineering/).
