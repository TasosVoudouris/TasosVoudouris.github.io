---
title: "From DKG Output to Threshold Signatures"
description: "Connect distributed key material to threshold signing without reconstructing the secret, define signer/coordinator roles, and establish the object flow used by the reviewed FROST lesson."
pubDate: "2026-08-12"
...
1. [Shamir secret sharing](/series/threshold-cryptography-engineering/)
2. [Feldman VSS](/series/threshold-cryptography-engineering/)
3. [From VSS to DKG](/series/threshold-cryptography-engineering/)
4. [The multi-dealer construction](/series/threshold-cryptography-engineering/)
5. [DKG qualification and public-key derivation](/series/threshold-cryptography-engineering/)
...
Continue with [Schnorr algebra and threshold interpolation](/series/threshold-cryptography-engineering/),
then [the two-round FROST protocol](/series/threshold-cryptography-engineering/).
