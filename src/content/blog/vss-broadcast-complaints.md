---
title: "VSS Protocol Boundary: Broadcast, Complaints, and Reconstruction Policy"
description: "Move beyond the local Feldman equation to consistent commitment broadcast, complaints, reconstruction policy, and the distinction between VSS and robust decoding."
pubDate: "2026-08-12"
...
Next: [Audit of the original VSS experiments](/series/threshold-cryptography-engineering/),
then [Pedersen VSS](/series/threshold-cryptography-engineering/).
